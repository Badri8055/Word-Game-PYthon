...
window.title("Group 4-Find word")
...
btn66 = Button(f2, text="T", bg="red", fg="Black", width=3, height=1, font=('Helvetica', '20'),
               command=lambda: click(btn66))
btn66.grid(column=6, row=6)
btn67 = Button(f2, text="P", bg="red", fg="Black", width=3, height=1, font=('Helvetica', '20'),
...
btn78 = Button(f2, text="I", bg="red", fg="Black", width=3, height=1, font=('Helvetica', '20'),
               command=lambda: click(btn78))
btn78.grid(column=6, row=7)
btn79 = Button(f2, text="N", bg="red", fg="Black", width=3, height=1, font=('Helvetica', '20'),
